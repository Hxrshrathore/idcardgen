  ...
  return (
    <div className="w-full h-full bg-[#0a0a0c] border border-zinc-900 lg:border-r-0 lg:border-b-0 lg:rounded-r-none lg:rounded-b-none rounded-xl flex flex-col overflow-hidden select-none relative">
      ...
      >
        ...
        {/* Absolute Glassmorphic Compiler Loading Overlay */}
        {batchStatus === 'processing' && (
          <div className="absolute inset-0 bg-black/80 backdrop-blur-md z-30 flex flex-col items-center justify-center p-6 transition-all duration-300">
            <div className="flex flex-col items-center gap-4 max-w-sm w-full text-center">
              ...
              <div className="w-full h-1 bg-zinc-900 rounded-full overflow-hidden mt-1 border border-zinc-850">
      ...
      <div className="grid grid-cols-3 gap-3 px-4 py-3 bg-[#0a0a0c] border-t border-zinc-900 shrink-0">
        {/* Mockup Case ON/OFF */}
        <button
          type="button"
...
`);
  ...
  return (
    <main className="min-h-screen lg:h-screen w-full flex flex-col items-stretch bg-[#030303] py-12 lg:pt-4 lg:pb-0 pl-4 pr-4 lg:pl-6 lg:pr-0 select-none relative overflow-hidden text-white font-mono lg:justify-start">
